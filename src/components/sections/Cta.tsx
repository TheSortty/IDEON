...
const Cta: React.FC = () => {
  ...
  return (
    <section id="contacto" className="relative overflow-hidden bg-gray-50 dark:bg-brand-background scroll-mt-24">
      {/* Background Gradient */}
      ...
      {/* LED Bars */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-accent/50 to-transparent shadow-[0_0_10px_rgba(212,0,255,0.5)]"></div>
      ...
      <div className="container-site text-center relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-lg text-content-muted max-w-2xl mx-auto mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              <Button
                ...
                className="text-lg px-8 py-6 shadow-[0_0_30px_rgba(212,0,255,0.4)] hover:shadow-[0_0_50px_rgba(212,0,255,0.6)] transition-shadow duration-300"
              >
                Contame tu idea →
              </Button>
            </motion.div>
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button onClick={() => openModal()} variant="outline" className="text-lg px-8 py-6">
